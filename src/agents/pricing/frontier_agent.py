...
class FrontierAgent(Agent):
    ...
    def __init__(self, collection):
        ...
        self.retriever = ChromaRetriever(collection=collection)
    ...
    def messages_for(
        ...
        """
        message = (
            f"Estimate the price of this product. Respond with the price, no explanation\n\n{description}\n\n"
        )
    ...
    def find_similars(self, description: str):
        ...
        documents, prices = self.retriever.query_similars(description, n_results=5)
